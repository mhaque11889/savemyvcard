...
<body style="background: #022332;">
        ...
        <div class="container">
          ...
          <div class="row">
              ...
              <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="pt-4 pb-2">
                        ...
                        <p class="text-center small">Please provide the details below to register</p>
                    </div>
                    <form class="row g-3 needs-validation" novalidate method="POST" action="{{url('/registerCheck')}}" id="memberRegistration">
                        @csrf
                        <div class="col-12">
                        ...
                        <div class="col-4">
                              <label for="parent1contactcc" class="form-label">Country*</label>
                              <select class="form-select" id="parent1contactcc" name="parent1contactcc" required="">
                        ...
                        <div class="col-8">
                            ...
                            <div class="input-group has-validation">
                                <input type="number" name="mobileNumber" class="form-control" id="mobileNumber" required oninput="validateNumber(this)">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="password" class="form-control" id="captcha" required>
                            <div class="invalid-feedback">Please provide captcha</div>
                        </div>

                        <div class="col-6">
                            <label for="captcha_image" onclick="refreshCaptchaImage()" style="width:100%;text-align:right; font-size:12px; color:blue">Refresh</label>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <a href="{{url('/forgotPassword')}}"><button class="btn btn-danger w-100" type="button">Forgot Password</button></a>
                        </div>
                    </form>
                </div>
              </div>
            ...
            <div class="col-lg-7 col-md-6" >
                <div class="image-rings" style="background-image: url({{url('/img/image_bg.png')}}); background-size: contain; background-repeat:no-repeat">
  ...
  <script>
    function validateNumber(input) {
        ...
        // Set the validated value back to input
        input.value = value;
    }
    </script>
